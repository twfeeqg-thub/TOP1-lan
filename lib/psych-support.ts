...
export const logoutFarewellMessages = [
  'إلى اللقاء! نراك قريباً — أنت جزء من عائلتنا دائماً',
  'وداعاً ودوداً لك، ونتمنى لك يوماً مليئاً بالنجاح',
  'شكراً لمرورك معنا اليوم، نترقب عودتك',
  'لا تقل وداعاً، بل إلى اللقاء القريب',
]

export const loginErrorMessages = [
  'لا بأس، قد تحتاج كلمة المرور لمراجعة — أنت على بعد خطوة',
  'لم نستطع تسجيل دخولك بعد، تحقق من البيانات وحاول مجدداً بهدوء',
  'لا تقلق، الأخطاء الصغيرة تسبق النجاح الكبير',
  'يبدو أن هناك خطأ بسيطاً في البيانات — أنت أقرب مما تظن',
]
